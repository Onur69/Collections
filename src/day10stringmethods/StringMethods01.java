...
String s = "Java ah Java!";
		...
		/* Note:Bazen kod yazarken kirmizi alt cizgi aliriz bu hata yapiyoruz demektir.
		   ...
		   Note: charAt() methodunda var olmayan bir index kullanirsaniz Run Time Error
	    	     ...
	    	     System.out.println(s.charAt(13)); yukarda ki notlar icin ornektir
	    ...
	    */		 
		...
		//3. Method endsWith() methodu---with==>ile 
		...
		//4. Method length() methodu---length==>uzunluk
		...
		//5. Method toUpperCase() methodu----to uppercase==>buyuk harfe
		String y = "Maske takiniz!";
		System.out.println(y.toUpperCase());//MASKE TAKINIZ!
		
		//6. Method toLowerCase() methodu---toLowerCase==>kucuk harfe
		String z = "Evde Kal!";
		System.out.println(z.toLowerCase());//evde kal!
		
		//7. Method replace();-----replace==>degistirmek
