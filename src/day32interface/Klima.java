...
public interface Klima  {
	...
	2- "default" veya "static" keyword'lerden birini kullanirsaniz mutlaka 
	  method body'si kullanmaniz gerekir.
	  Aksi taktirde CTE alirsiniz.
	  public default void m1();==>olmaz
	  public static void m2();==>olmaz
	3- "default" veya "static" keyword'lerden birini kullanirak olusturdugunuz
	  body'li methodlari child class'larin override etme zorunlulugu yoktur.
	*/
